...
const MerkleTreeStream = require("merkle-tree-stream/generator");
...
class Block {
    constructor(index, hash, previousHash, timestamp, data, difficulty, nonce, merkleRoot, merkleTree) {
        this.index = index;
...
const genesisTransaction = {
    ...
    'txOuts': [{
            ...
            'hash': CryptoJS.RIPEMD160(CryptoJS.SHA256('04bfcab8722991ae774db48f934ca79cfb7dd991229153b9f732ba5334aafcd8e7266e47076996b55a14bf9913ee3145ce0cfc1372ada8ada74bd287450313534a')),
            'amount': 50
        }],
    'id': 'e655f6a5f26dc9b4cac6e46f52336428287759cf81ef5ff10854f69d68f43fa3'
};
const genesisBlock = new Block(0, '91a73664bc84c0baa1fc75ea6e4aa6d1d20c5df664c724e3159aefc2e1186627', '', 1465154705, [genesisTransaction], 0, 0, "0", gen);
let blockchain = BLOCKS_FILE;
// the unspent txOut of genesis block is set to unspentTxOuts on startup
//let unspentTxOuts: UnspentTxOut[] = processTransactions(blockchain[0].data, [], 0);
let unspentTxOuts = TRANSACTION_FILE;
...
const generateRawNextBlock = (blockData) => {
    ...
    const newBlock = findBlock(nextIndex, previousBlock.hash, nextTimestamp, blockData, difficulty, merkleRoot);
...
const findBlock = (index, previousHash, timestamp, data, difficulty, merkleRoot) => {
    let nonce = 0;
    while (true) {
...
const sendTransaction = (address, amount) => {
    const hash160_2 = CryptoJS.RIPEMD160(CryptoJS.SHA256(address));
    const tx = wallet_1.createTransaction(hash160_2, amount, wallet_1.getPrivateFromWallet(), getUnspentTxOuts(), transactionPool_1.getTransactionPool());
