...
const createTransaction = (receiverAddress, amount, privateKey, unspentTxOuts, txPool) => {
    ...
    const PUBKey = transaction_1.getPublicKey(privateKey); /////
    /////
    const HASH160 = CryptoJS.RIPEMD160(CryptoJS.SHA256(PUBKey));
    /////
    const myUnspentTxOutsA = unspentTxOuts.filter((uTxO) => uTxO.hash === HASH160); /////*****/////
